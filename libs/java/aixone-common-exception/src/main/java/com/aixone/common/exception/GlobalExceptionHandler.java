...
public class GlobalExceptionHandler {
    ...
    public ApiResponse<Void> handleNotFoundException(NotFoundException ex) {
        return new ApiResponse<>(404, ex.getMessage(), null, LocalDateTime.now());
    }
    ...
    public ApiResponse<Void> handleForbiddenException(ForbiddenException ex) {
        return new ApiResponse<>(403, ex.getMessage(), null, LocalDateTime.now());
    }
    ...
    public ApiResponse<Map<String, String>> handleValidationExceptions(MethodArgumentNotValidException ex) {
        ...
        return new ApiResponse<>(400, "参数校验失败", errors, LocalDateTime.now());
    }
    ...
    public ApiResponse<Map<String, String>> handleBindException(BindException ex) {
        ...
        return new ApiResponse<>(400, "参数绑定失败", errors, LocalDateTime.now());
    }
    ...
    public ApiResponse<Void> handleException(Exception ex) {
        return new ApiResponse<>(500, ex.getMessage() != null ? ex.getMessage() : "系统异常", null, LocalDateTime.now());
    }
