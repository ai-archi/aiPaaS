...
# 生成依赖 classpath
echo "生成依赖 classpath..."
mvn dependency:build-classpath -Dmdep.outputFile=/tmp/auth-classpath.txt -q

# 读取 classpath
DEPENDENCY_CLASSPATH=$(cat /tmp/auth-classpath.txt)
...
# 启动命令
MAIN_CLASS="com.aixone.tech.auth.AuthApplication"
