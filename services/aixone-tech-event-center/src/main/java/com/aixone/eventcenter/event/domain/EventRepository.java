...
public interface EventRepository extends Repository<Event, Long> {
     ...
     * 根据时间范围查找事件
     */
    List<Event> findByCreatedAtBetween(Instant startTime, Instant endTime);
    
    /**
     * 根据租户ID和时间范围查找事件
     */
    List<Event> findByTenantIdAndCreatedAtBetween(String tenantId, Instant startTime, Instant endTime);
