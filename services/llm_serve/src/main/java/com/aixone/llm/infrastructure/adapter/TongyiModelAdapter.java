...
public class TongyiModelAdapter extends OpenAIModelAdapter {
    ...
    public TongyiModelAdapter(WebClient.Builder webClientBuilder) {
        ...
        this.webClient = webClientBuilder.baseUrl("https://dashscope.aliyuncs.com/api/v1").build();
    }

    @Override
    public List<String> getModelNames() {
        return Arrays.asList("wanx2.1-imageedit",
        "wanx2.1-imageedit-v2","wanx2.1-t2i-turbo","wanx2.1-t2i-plus","wanx2.0-t2i-turbo","wanx-style-repaint-v1",
